...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { hobbies: @user_profile.hobbies, profile_pic: @user_profile.profile_pic, starsign: @user_profile.starsign, user_id: @user_profile.user_id }
    end
  ...
  test "should update user_profile" do
    patch :update, id: @user_profile, user_profile: { hobbies: @user_profile.hobbies, profile_pic: @user_profile.profile_pic, starsign: @user_profile.starsign, user_id: @user_profile.user_id }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
